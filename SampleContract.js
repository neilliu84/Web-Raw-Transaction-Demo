...
var SampleContractAddress = '0xa71d54be6c38019fc8eb23843a8636d476dae406';
...
function openKeyFile(event) {
    ...
    reader.onload = (function(theFile) {
        return function(e) {
            ...
            // var json = require('./UTCkey.json')
            // var jsonOb = JSON.stringify(json)
            // alert(jsonOb)
...
function doRawTxn(eth) {
   ...
   // alert(data_setX)
    ...
    // const privateKey = Buffer.from('a6582400d52f802a6136ac3a220c078387fba4064b3b6382ca50efad55fb92ef', 'hex')
    ...
    const txParam_setX = {
        nonce: nonce_1_hex,
        gasPrice: '0x0000000400'/*'0x04e3b29200'*/,
        gasLimit: '0x6de3',
        to: '0xa71d54be6c38019fc8eb23843a8636d476dae406',
        value: '0x00',
        data: data_setX,
